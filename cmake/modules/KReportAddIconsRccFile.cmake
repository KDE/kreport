...
# - adds a update_all_rcc target that executes commands for all targets created with kreport_add_icons_rcc_file()
macro(kreport_add_icons_rcc_file _target _parent_target _theme _prefix)
    set(_BASE_DIR ${CMAKE_CURRENT_BINARY_DIR}/resource)
    set(_QRC_FILE "${_BASE_DIR}/${_target}.qrc")
    set(_RCC_DIR "${CMAKE_BINARY_DIR}/bin/data/${KREPORT_BASE_NAME_LOWER}/icons")
...
# For example, icons/org.kde.kreport.barcode/breeze/actions/16/kreport-barcode-element.svg.
# This helps to make plugins not conflicting.
macro(kreport_add_plugin_icons_rcc_file _plugin_target _theme)
    kreport_add_icons_rcc_file(${_plugin_target}_${_theme} ${_plugin_target} ${_theme} ${_plugin_target})
endmacro()
